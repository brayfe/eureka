...
namespace Drupal\eureka_contacted_faculty\Plugin\views\field;

use Drupal\eureka_contacted_faculty\Controller\ActionLinkController;
 ...
 *
 * @ViewsField("contacted_faculty")
 */
class ContactedFacultyViewsLinkField extends FieldPluginBase {
  ...
  protected function renderLink(EntityInterface $entity, ResultRow $values) {
    ...
    return ActionLinkController::buildLink($entity->id());
  }
